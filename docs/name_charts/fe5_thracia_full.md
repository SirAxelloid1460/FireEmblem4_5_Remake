# Name Chart completa (multi-idioma) — Fire Emblem: Thracia 776 (FE5)

Fuente: Fire Emblem Wiki (Name chart), aportada por el usuario. Se conserva **tal
cual** como referencia de localización. Cubre **Lugares, Ítems (armas y objetos),
Habilidades y Clases** con sus formas en varios idiomas.

Columnas: **Kana · Romaji (Hepburn) · NoJ · Fan · NoA · NoE · Francés · Alemán ·
Español · Italiano**. `--` = sin dato; `??` = desconocido; `*` = nota de la fuente.

> Los personajes/enemigos están en `fe5_thracia.md`. Este archivo complementa con
> las secciones de contenido. Las columnas FR/DE/ES/IT son especialmente útiles
> para la sesión de traducción (localización de ítems/clases/lugares).

## Lugares

| Kana | Romaji | NoJ | Fan | NoA | NoE | FR | DE | ES | IT |
|---|---|---|---|---|---|---|---|---|---|
...
| ブラギの塔 | Buragi no tō | -- | Bragi Tower | Tower of Bragi | -- | -- | -- | -- | -- |
...
| ノルデン | Noruden | Nohrden | Nordrhein | Norden | Norden | -- | -- | -- | -- |
...
| Ｓドリンク | S dorinku | -- | Stamina Drink | S Drink | S Drink | Boisson S | G-Getränk | Poción de vigor | Elisir speciale |
...
| エリートＭ | Erīto M | -- | Paragon Manual | -- | -- | -- | -- | -- | -- |
| いかりＭ | Ikari M | -- | Wrath Manual | -- | -- | -- | -- | -- | -- |
| まちぶせＭ | Machibuse M | -- | Vantage Manual | -- | -- | -- | -- | -- | -- |
| とつげきＭ | Totsugeki M | -- | Accost Manual | -- | -- | -- | -- | -- | -- |
| たいようＭ | Taiyō M | -- | Sol Manual | -- | -- | -- | -- | -- | -- |
| みきりＭ | Mikiri M | -- | Nihil Manual | -- | -- | -- | -- | -- | -- |
| げっこうＭ | Gekkō M | -- | Luna Manual | -- | -- | -- | -- | -- | -- |
| れんぞくＭ | Renzoku M | -- | Adept Manual | -- | -- | -- | -- | -- | -- |
...
| ねぎりＭ | Negiri M | -- | Bargain Manual | -- | -- | -- | -- | -- | -- |
| いのりＭ | Inori M | -- | Miracle Manual | -- | -- | -- | -- | -- | -- |

## Habilidades (Skills)

| Kana | Romaji | NoJ | Fan | NoA | NoE | FR | DE | ES | IT |
|---|---|---|---|---|---|---|---|---|---|
| たいよう剣 | Taiyōken | -- | Sol | Sol | -- | -- | -- | -- | -- |
| げっこう剣 | Gekkōken | -- | Luna | Luna | -- | -- | -- | -- | -- |
| りゅうせい剣 | Ryūseiken | -- | Astra | Astra | -- | -- | -- | -- | -- |
...
| プリースト | Purīsuto | Priest / Priestess | Priest | Priest | Priest | Vicaire | Heiler | Sacerdote | Sacerdote |
| ハイプリースト | Hai purīsuto | High Priest / High Priestess | -- | -- | -- | -- | -- | -- | -- |
| ビショップ | Bishoppu | Bishop | Bishop | Bishop | Bishop | Evêque | Bischof | Obispo | Vescovo |
| シビリアン | Shibirian | Civilian | Civilian | Civilian | Civilian | Villageois | Zivilist* / Zivilistin* | Civil | Borghese |
...
| ダークビショップ | Dāku bishoppu | Dark Bishop | Dark Bishop | Dark Bishop | Dark Bishop | Évêque noir | Dunkelbischof | Obispo oscuro | Vescovo oscuro |
