# Name Chart — Fire Emblem: Thracia 776 (FE5)

Fuente: Fire Emblem Wiki (Name chart), aportada por el usuario. Se conserva **tal
cual** como referencia de localización.
Columnas: **Japonés · Romaji · Nombre NOJ · Nombre fan · Alternativo · Localizado**.
El "Localizado" es el que usa el proyecto (`data/general/units.json` → `name`).

## Personajes

| Japonés | Romaji | NOJ | Fan | Alternativo | Localizado |
|---|---|---|---|---|---|
