...
VERSIONED = [
    ...
    {  # Caballerías iguales: Cavalier, Free Knight, Axe Knight
        "ids": ["Cavalier", "FreeKnight", "AxeKnight"],
    ...
    {  # Duke Knight  (Lance Knight -> Duke Knight; Finn override per-juego)
        ...
        "promotions": {
            "LanceKnight":       {"FE5": [2, 1, 3, 2, 2, 1, 1, 0]},   # genérico (FE4 = solo Finn)
            "LanceKnight@Finn":  {"FE4": [5, 0, 1, 1, 2, 3, 1, 0], "FE5": [1, 1, 3, 2, 2, 1, 1, 0]},
        },
    },
