...
#   FE4 / SAGA → assets/videos/fe4/intros/fe4_{idioma}.ogv   (SAGA arranca con FE4)
#   FE5        → assets/videos/fe5/intros/fe5_{idioma}.ogv   (intro de Thracia 776)
# El idioma sale del locale (ja → jp); si no existe el del idioma actual se cae al
# _en de la misma carpeta (ver VideoResolver). Si no hay ninguno, se salta directo
# al menú (sin romper).
# ============================================================
